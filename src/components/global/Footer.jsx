  ...
  return (
    <div className="bg-(--moerkblaa-600) text-(--moerkblaa-100) grid grid-cols-1 md:grid-cols-3 gap-8 p-5">
      ...
      <div className="pt-10 md:pt-40 flex flex-col items-center text-center">
        <p className="font-extrabold pb-4 text-white text-2xl">Hold dig opdateret</p>
      ...
      <div className="pt-10 md:pt-40 flex flex-col items-center md:items-end text-center md:text-right">
        ...
        <div className="pt-10 flex flex-col items-center md:items-end">
          <div className="pb-4">
            <button className="text-(--koboltblaa-600) border-2 border-(--koboltblaa-600) bg-(--bellevueblaa-100) pt-3 pb-3 pl-15 pr-15 rounded-xl">Find vej</button>
          </div>
          <p className="text-center font-bold md:text-right max-w-49">Strandvejen 451​ 2930 Klampenborg</p>
        </div>
      </div>
