      ...
      {items.map((item) => (
        ...
        >
          ...
          <div className="pl-3 pb-4 pt-20">
            ...
            className="bg-blue-100 text-blue-800 border border-blue-800 pt-2 pb-2 pl-7 pr-7 rounded-2xl mr-4">Køb billet</Link>
            <Link 
            href={`/forestillinger/${item.id}`} 
            className=" text-blue-800 border border-blue-800 pt-2 pb-2 pl-7 pr-7 rounded-2xl">Læs mere</Link>
          </div>
        </li>
      ))}
    </>
